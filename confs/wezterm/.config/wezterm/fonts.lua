...
function module.apply_to_config(config)
	-- Set the font to use
	-- config.font = wezterm.font("JetBrains Mono", { weight = "Regular", stretch = "Normal", style = "Italic" }) -- <built-in>, BuiltIn
	...
	-- config.font = wezterm.font("CaskaydiaCove Nerd Font Mono", { weight = "Regular", stretch = "Normal", style = "Normal" }) -- (AKA: CaskaydiaCove NFM) C:\USERS\CARLO\APPDATA\LOCAL\MICROSOFT\WINDOWS\FONTS\CASKAYDIACOVENERDFONTMONO-REGULAR.TTF, DirectWrite
	-- config.font = wezterm.font("Consolas", { weight = "Bold", stretch = "Normal", style = "Normal" }) -- C:\WINDOWS\FONTS\CONSOLAB.TTF, DirectWrite
